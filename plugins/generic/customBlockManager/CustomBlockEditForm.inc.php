 ...
 *
 * Form for site admins to create and modify sidebar blocks
 *
 */
...
class CustomBlockEditForm extends Form {
	 ...
	 * Constructor
	 */
	function CustomBlockEditForm(&$plugin) {
	...
	function initData() {
		...
		$this->addTinyMCE();
		$this->setData('blockContent', $plugin->getSetting('blockContent'));
	}
	...
	function addTinyMCE() {
		...
		<script language="javascript" type="text/javascript">
			...
			theme_advanced_buttons2 : "bold,italic,underline,separator,strikethrough,justifyleft,justifycenter,justifyright, justifyfull,bullist,numlist,undo,redo,link,unlink,jbimages",
	...
	function save() {
		$plugin =& $this->plugin;
		$plugin->updateSetting('blockContent', $this->getData('blockContent'));
	}
