...
{url|assign:"pluginsUrl" page="admin" op="plugins"}
{url|assign:"layout" page="admin" op="layout"}
{translate key="plugin.generic.customBlockManager.introduction" pluginsUrl=$pluginsUrl layout=$layout}
