{**
 * plugins/generic/staticPages/settings.tpl
 *
...
<p><input type="button" value="{translate key="common.done"}" class="button defaultButton" onclick="document.location.href='{url page="admin" op="plugins" escape=false}'" /></p>
