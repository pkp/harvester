...
<p><input type="submit" value="{translate key="installer.installHarvester2"}" class="button defaultButton" /> <input type="submit" name="manualInstall" value="{translate key="installer.manualInstall"}" class="button" /></p>
