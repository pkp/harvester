...
b);f=b.outerWidth(!0)-b.width();b.css("max-width",c-(d+e+f))}})(jQuery);(function(a){a.pkp.controllers.UrlInDivHandler=function(b,a){this.parent(b,a);this.sourceUrl_=a.sourceUrl;this.reload()};a.pkp.classes.Helper.inherits(a.pkp.controllers.UrlInDivHandler,a.pkp.classes.Handler);a.pkp.controllers.UrlInDivHandler.sourceUrl_=null;a.pkp.controllers.UrlInDivHandler.prototype.reload=function(){a.get(this.sourceUrl_,this.callbackWrapper(this.handleLoadedContent_),"json")};a.pkp.controllers.UrlInDivHandler.prototype.handleLoadedContent_=function(b,a){var d=this.handleJson(a);
...
c=a("#"+e,b);b.validate().element(c)}))};a.pkp.controllers.form.FormHandler.prototype.onFocusOutValidation_=function(b,c){var d=this.getHtmlElement();a(c).parents("#"+d.attr("id")).length&&b.element(c);return!0}})(jQuery);(function(a){a.pkp.controllers.form.MultilingualInputHandler=function(b,a){this.parent(b,a);var d=null,d=b.hasClass("pkpTagit")?b.find(":input").filter(":visible"):b.find(":input").first();d.focus(this.callbackWrapper(this.focusHandler_));b.find(":input").blur(this.callbackWrapper(this.blurHandler_));this.publishEvent("tinyMCEInitialized");this.bind("tinyMCEInitialized",this.tinyMCEInitHandler_)};a.pkp.classes.Helper.inherits(a.pkp.controllers.form.MultilingualInputHandler,a.pkp.classes.Handler);
...
this.hidePopover_()}),0)}))}})(jQuery);(function(a){a.pkp.controllers.form.ClientFormHandler=function(b,a){a.submitHandler=this.submitForm;this.parent(b,a)};a.pkp.classes.Helper.inherits(a.pkp.controllers.form.ClientFormHandler,a.pkp.controllers.form.FormHandler);a.pkp.controllers.form.ClientFormHandler.prototype.submitForm=function(){var b;b=this.getHtmlElement().serializeArray();b.push({name:"clientSubmit",value:!0});this.trigger("formSubmitted",[a.param(b)])}})(jQuery);(function(a){a.pkp.controllers.grid=a.pkp.controllers.grid||{};a.pkp.controllers.grid.GridHandler=function(b,a){this.parent(b,a);this.initialize(a);this.initFeatures_(a.features)};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.GridHandler,a.pkp.classes.Handler);a.pkp.controllers.grid.GridHandler.prototype.bodySelector=null;a.pkp.controllers.grid.GridHandler.prototype.fetchRowUrl=null;a.pkp.controllers.grid.GridHandler.prototype.gridId_=null;a.pkp.controllers.grid.GridHandler.prototype.fetchGridUrl_=
...
c=!1;1==this.getElementsByType(b).length&&(c=!0);b.hasClass("gridRow")&&this.deleteControlsRow_(b);d=this.getEmptyElement(b);b.fadeOut(500,function(){a(this).remove();c&&d.fadeIn(500)})};a.pkp.controllers.grid.GridHandler.prototype.appendElement=function(b,a){if(void 0===a||null===a)a=this.getHtmlElement().find(this.bodySelector);a.append(b);this.getEmptyElement(b).hide();this.callFeaturesHook("appendElement",b)};a.pkp.controllers.grid.GridHandler.prototype.replaceElement=function(b,a){a.hasClass("gridRow")&&
this.deleteControlsRow_(b);b.replaceWith(a);this.callFeaturesHook("replaceElement",a)};a.pkp.controllers.grid.GridHandler.prototype.hasSameNumOfColumns=function(b,a){var d,e;d=this.getHtmlElement().find("th").length;e=b.first().find("td");e=a?e.attr("colspan"):e.length;return d==e};a.pkp.controllers.grid.GridHandler.prototype.replaceElementResponseHandler=function(a,c){var d;d=this.handleJson(c);if(!1!==d)if(d.elementNotFound){d=d.elementNotFound;d=this.getHtmlElement().find(".element"+d);if(0===
