...
class BlockPlugin extends Plugin {
	...
	function setBlockContext($context) {
		return $this->updateSetting('context', $context, 'int');
	}
	...
	function setEnabled($enabled) {
		return $this->updateSetting('enabled', $enabled, 'bool');
	}
	 ...
	 */
	function setSeq($i) {
		return $this->updateSetting('seq', $i, 'int');
	}
