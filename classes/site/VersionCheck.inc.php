 ...
 *
 * VersionCheck class.
 * Provides methods to check for the latest version of Harvester2.
 *
 * $Id$
 */

define('VERSION_CHECK_URL', 'http://pkp.sfu.ca/harvester2/harvester2-version.xml');
...
class VersionCheck {
	...
	function &parseVersionXML($url) {
		...
		if (isset($data['patch'])) foreach ($data['patch'] as $patch) {
